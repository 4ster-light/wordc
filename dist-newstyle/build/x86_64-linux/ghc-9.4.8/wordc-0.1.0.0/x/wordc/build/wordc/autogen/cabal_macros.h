...
/* package wordc-0.1.0.0 */
#ifndef VERSION_wordc
#define VERSION_wordc "0.1.0.0"
#endif /* VERSION_wordc */
#ifndef MIN_VERSION_wordc
#define MIN_VERSION_wordc(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_wordc */
...
#define CURRENT_COMPONENT_ID "wordc-0.1.0.0-inplace-wordc"
